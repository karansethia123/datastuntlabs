...
export function AuditSection() {
  ...
  return (
    <section id="audit" ref={sectionRef} className="py-24 px-6 bg-[#0a0a0a]">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-16">
          ...
          <p className="reveal text-base text-[#737373] max-w-3xl leading-relaxed mb-4">
        ...
        <div className="mb-16">
          ...
          <p className="reveal text-base text-[#737373] max-w-3xl leading-relaxed mb-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[rgba(255,255,255,0.08)] border border-[rgba(255,255,255,0.08)] rounded-[4px] overflow-hidden">
            {dimensions.map(({ name, description }) => (
              <div key={name} className="reveal bg-[#0a0a0a] p-6 group hover:bg-[rgba(2,132,199,0.02)] transition-colors">
                <h4
        ...
        <div className="mb-16">
          ...
          <p className="reveal text-base text-[#737373] max-w-3xl leading-relaxed">
            Every Audit is powered by DAIRS — the Datastunt AI Readiness &amp; Resilience System. Each of the nine dimensions feeds directly into DAIRS scores, producing quantifiable, comparable benchmarks rather than subjective opinions. <Link href="#dairs" className="text-[#0284c7] hover:underline">Learn more about DAIRS →</Link>
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <p
            className="reveal text-sm text-[#0284c7] font-bold"
            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
          >
        ...
        <div className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {deliverables.map(({ audience, items }) => (
              <div key={audience} className="reveal bg-[#111111] border border-[rgba(255,255,255,0.08)] rounded-[4px] p-6">
                <p
                  className="text-xs text-[#0284c7] font-bold uppercase tracking-wider mb-2"
                  style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                >
                  {audience}
                </p>
                <p className="text-sm text-[#a3a3a3] leading-relaxed">{items}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="reveal border border-[rgba(2,132,199,0.2)] rounded-[4px] p-8 bg-[rgba(2,132,199,0.02)]">
          <h3
