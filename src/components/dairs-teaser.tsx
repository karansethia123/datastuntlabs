  ...
  return (
    <section ref={sectionRef} className="py-24 px-6 bg-background">
      <div className="container mx-auto max-w-7xl">
        <div className="reveal section-glow border border-primary/20 rounded-[4px] p-10 md:p-14 bg-primary/[0.03] relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            {/* Headline */}
            <h2
              className="text-[clamp(1.75rem,4vw,2.5rem)] font-bold text-foreground mb-4 leading-tight"
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 text-sm text-accent hover:text-accent/80 transition-colors font-bold"
              style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
            >
