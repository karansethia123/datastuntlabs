...
export function ICPSection() {
  ...
  return (
    <section id="who-we-work-with" ref={sectionRef} className="py-24 px-6 bg-background">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <h2
              className="reveal text-[clamp(2rem,4vw,3rem)] font-bold text-foreground mb-4 leading-tight"
              style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
            >
              Built for Builders,<br />Not Explorers.
            </h2>
            <p className="reveal text-lg text-muted-foreground mb-10 leading-relaxed">
            ...
            <ul className="space-y-4 mb-10">
              {fits.map((fit) => (
                <li key={fit} className="reveal flex items-start gap-3">
                  ...
                  <span className="text-sm text-foreground">{fit}</span>
                </li>
              ))}
            </ul>

            {/* Not a fit */}
            <div className="reveal border-l-2 border-border pl-4">
          ...
          <div>
            ...
            {/* Callout box */}
            <div className="reveal border border-primary/20 rounded-[4px] p-8 bg-primary/[0.03]">
              <p
