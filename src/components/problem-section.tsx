  ...
  return (
    <section ref={sectionRef} className="py-24 px-6 bg-background">
      <div className="container mx-auto max-w-7xl">
        ...
        {/* Body */}
        <p className="reveal text-lg text-muted-foreground max-w-2xl mb-16 leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {problems.map(({ icon: Icon, label, description }) => (
            <div
              key={label}
              className="reveal card-glass group"
            >
              <div className="flex items-start gap-4 mb-4">
                <div className="w-10 h-10 rounded-[4px] bg-muted border border-border flex items-center justify-center flex-shrink-0 group-hover:border-accent transition-colors duration-200">
